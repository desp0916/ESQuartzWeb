...
import com.pic.eqw.job.ColorJob;
/**
...
public class JobStateExample {
	...
	public void run(Scheduler sched) throws Exception {
		...
		job1.getJobDataMap().put(ColorJob.FAVORITE_COLOR, "綠色");
		...
		job2.getJobDataMap().put(ColorJob.FAVORITE_COLOR, "紅色");
		job2.getJobDataMap().put(ColorJob.EXECUTION_COUNT, 1);

		// schedule the job to run
		Date scheduleTime2 = sched.scheduleJob(job2, trigger2);
		log.info(job2.getKey().toString() + " will run at: " + scheduleTime2
				+ " and repeat: " + trigger2.getRepeatCount() + " times, every "
		...
		log.info("總共執行了 " + metaData.getNumberOfJobsExecuted() + " 個 jobs.");
